...
class NarrativeAccelerationAgent(BaseAgent):
    def __init__(
        self,
        *,
        ...
        super().__init__(
            agent_name="narrative_acceleration_agent",
            question_template="Which narratives are accelerating unusually fast?",
            system_prompt=self.load_prompt("prompts/maps_system_prompt.md"),
            agent_prompt=self.load_prompt("prompts/narrative_acceleration_agent.md"),
